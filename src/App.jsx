...
// Автоматичний конвертер посилань з Google Диску, Dropbox та локальних завантажень (Base64)
const formatImageUrl = (url) => {
  if (!url) return 'https://images.unsplash.com/photo-1602491453979-53a99888ecf1?auto=format&fit=crop&q=80&w=600';
  let cleanUrl = url.trim();
  
  // Файл завантажений з пристрою (Base64)
  ...
  // Конвертація посилань Google Диску виду: ?id=FILE_ID
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans antialiased pb-20 selection:bg-red-800 selection:text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        {activeTab === 'admin' && isAdmin && (
          <div>
            ...
            {/* ВКЛАДКА ТОВАРІВ З МИТТЄВИМ ЗАВАНТАЖЕННЯМ ФОТОЗ ПРИСТРОЮ */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div className="lg:col-span-5 bg-zinc-900 p-6 rounded-3xl border border-zinc-850 self-start">
                  ...
                  <form onSubmit={handleSaveProduct} className="space-y-4">
                    ...
                    {/* Поле зображення з кнопкою завантаження з пристрою */}
                    <div>
                      ...
                      <p className="text-[10px] text-zinc-500 mt-1.5">
                        💡 Можна вставити посилання з Google Диску або натиснути <b>«З пристрою 📁»</b> і вибрати будь-яку фотографію з ПК чи смартфона!
                      </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-zinc-950/80 p-5 rounded-2xl border border-zinc-800 flex flex-col justify-between">
                ...
                <button
                  ...
                  className="w-full bg-zinc-855 hover:bg-zinc-800 text-white font-bold py-3 rounded-xl text-xs uppercase transition-all border border-zinc-700"
                >
      ...
      {showLoginModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-zinc-900 border border-zinc-855 p-6 rounded-2xl w-full max-w-sm shadow-2xl">
            ...
            <form onSubmit={handleAdminLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-855 rounded-xl px-4 py-3 text-sm text-white focus:outline-none"
                  placeholder="••••"
                />
                {loginError && (
